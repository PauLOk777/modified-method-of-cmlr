...
@Component
public class RandomNumbersMmcmlrRequestBodyValidator implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return RandomNumbersMmcmlrRequestBody.class.isAssignableFrom(clazz);
    }

    @Override
    public void validate(Object target, Errors errors) {
        RandomNumbersMmcmlrRequestBody requestBody = (RandomNumbersMmcmlrRequestBody) target;
